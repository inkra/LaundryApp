								...
								<div class="card-body p-lg-17">
									...
									<div class="mb-18">
										...
										<div class="mb-10">
                                            ...
                                            <form action="./kasir/proses_ubah_detail_transaksi.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-username" name="dibayar" placeholder="Enter id kelas.." value="<?= $data['dibayar']?>">
                                            </div>
                                        </div>
										<div class="mb-3">
										...
										<strong><label class="col-lg-4 col-form-label" for="val-email">Status Order<span class="text-danger">*</span>
                                            ...
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="val-email" name="status" placeholder="Enter nama kelas.." value="<?= $data['status']?>">
                                            </div>
                                        </div>
										<div class="mb-3">
