					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-nav d-flex flex-column flex-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									<span class="menu-link active menu-center" title="General Pages" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon me-0">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link active" href="kasir/transaksi.php">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link" href="kasir/member.php" title="Silahkan melakukan registrasi pelanggan baru" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div class="card-body p-lg-17">
									...
									<div class="mb-18">
										...
										<?php while( $data_member = mysqli_fetch_assoc($result)) { ?>
											<a href="./kasir/transaksi.php" class="btn btn-secondary">Kembali</a> | 
											<a href="./kasir/cetak_transaksi.php?id_transaksi=<?=$data_member['id_transaksi']?>" target="_blank" class="btn btn-primary">Cetak Laporan Transaksi</a>
									...
									<table class="table table-hover">
															...
															$no++;?>
																	<tr class="text-xs font-weight-bold">
                                                                        ...
                                                                        <a class="btn btn-success" href="./kasir/ubah_detail_transaksi.php?id_transaksi=<?=$data_pembayaran['id_transaksi']?>" ><i class="far fa-edit"></i></a></td>
                                                                        </td>
																		</tr>
																	<?php
																	}
