						...
						<div class="aside-nav d-flex flex-column flex-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								<div class="menu-item py-2">
									<a class="menu-link menu-center" href="index_admin.php" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									<span class="menu-link active menu-center" title="CRUD Data" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon me-0">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link active" href="./admin/user.php" data-kt-page="pro">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
						...
						<div class="aside-workspace overflow-auto my-2 my-lg-7 px-3 px-lg-7" id="kt_aside_wordspace">
							...
							<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
								<div id="kt_aside_menu_wrapper" class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-offset="20px" data-kt-scroll-wrappers="#kt_aside_wordspace">
									<div class="menu-item">
										<div class="menu-content">
											<span class="menu-section fs-5 fw-bolder ps-1 py-1">CRUD Data Laundry</span>
										</div>
									</div>
									<div class="menu-item">
										<a class="menu-link active" href="./admin/user.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
									...
									<div class="menu-item">
										<a class="menu-link" href="./admin/outlet.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-1 fs-2">Our User Laundry App</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">CRUD User</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
									...
									<div class="mb-18">
										...
										<div class="mb-10">
											<!--begin::Top-->
												...
												<!--begin::Text-->
                                                <form action="./admin/proses_ubah_user.php" method="post">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="mb-3" style="text-align: left;">
                                                        <strong><label class="col-lg-4 col-form-label" for="val-username">Id User<span class="text-danger">*</span>
                                                        </label></strong>
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" id="val-username" name="id_user" placeholder="Enter id kelas.." value="<?= $data['id_user']?>">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3" style="text-align: left;">
                                                        <strong><label class="col-lg-4 col-form-label" for="val-username">Nama User<span class="text-danger">*</span>
                                                        </label></strong>
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" id="val-username" name="nama_user" placeholder="Enter id kelas.." value="<?= $data['nama_user']?>">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3" style="text-align: left;">
                                                        <strong><label class="col-lg-4 col-form-label" for="val-username">Username<span class="text-danger">*</span>
                                                        </label></strong>
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" id="val-username" name="username" placeholder="Enter id kelas.." value="<?= $data['username']?>">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3" style="text-align: left;">
                                                        <strong><label class="col-lg-4 col-form-label" for="val-username">Password<span class="text-danger">*</span>
                                                        </label></strong>
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" id="val-username" name="password" placeholder="Enter id kelas.." value="<?= $data['password']?>">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3" style="text-align: left;">
                                                    <strong><label class="col-lg-4 col-form-label" for="val-password">Nama Outlet<span class="text-danger">*</span>
                                                        </label></strong>
                                                        <div class="col-lg-12">
                                                        <select name="id_outlet" class="form-control">
                                                            ...
                                                            <?php
                                                                ...
                                                                while($data_outlet=mysqli_fetch_array($qry_outlet)){
                                                                    if($data_outlet['id_outlet']==$data['id_outlet']){
                                                                        $selek="selected";
                                                                    } else {
                                                                        $selek="";
                                                                    }
                                                    ...
                                                    <div class="mb-3" style="text-align: left;">
                                                    <strong><label class="col-lg-4 col-form-label" for="val-password">Role User<span class="text-danger">*</span>
                                                        </label></strong>
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" id="val-password" name="role" placeholder="Enter the jurusan..." value="<?= $data['role']?>">
                                                        </div>
                                                    </div>
                                                    <br><br>
                                                    <div class="form-group row" style="text-align: left;">
                                                        <div class="col-lg-8 ml-auto">
                                                            ...
                                                            <a href="./admin/user.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
                                                </form>
