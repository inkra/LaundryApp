							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link active" href="./admin/outlet.php" data-kt-page="pro">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
						...
						<div class="aside-workspace overflow-auto my-2 my-lg-7 px-3 px-lg-7" id="kt_aside_wordspace">
							...
							<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
								<div id="kt_aside_menu_wrapper" class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-offset="20px" data-kt-scroll-wrappers="#kt_aside_wordspace">
									...
									<div class="menu-item">
										<a class="menu-link" href="./admin/user.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
									...
									<div class="menu-item">
										<a class="menu-link active" href="./admin/outlet.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-1 fs-2">Our Outlet</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">CRUD Outlet</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container" id="kt_content_container">
							...
							<div class="card">
								<!--begin::Body-->
								<div class="card-body p-lg-17" style="text-align: left;">
									<!--begin::About-->
									<div class="mb-18" style="text-align: left;">
										<!--begin::Wrapper-->
										<div class="mb-10" style="text-align: left;">
											<!--begin::Top-->
												...
												<!--begin::Text-->
                                                <form action="./admin/proses_ubah_outlet.php" method="post">
                                                ...
                                                <div class="mb-3" style="text-align: left;">
                                                    <strong><label class="col-lg-4 col-form-label" for="val-username">Id Outlet<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-username" name="id_outlet" placeholder="Enter id kelas.." value="<?= $data['id_outlet']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-email">Nama Outlet<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-email" name="nama" placeholder="Enter nama kelas.." value="<?= $data['nama']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-password">Alamat Outlet<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-password" name="alamat" placeholder="Enter the jurusan..." value="<?= $data['alamat']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-password">Nomor Telepon<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-password" name="tlp" placeholder="Enter the angkatan..." value="<?= $data['tlp']?>">
                                                    </div>
                                                </div>
                                                <br><br>
                                                <div class="form-group row" style="text-align: left;">
                                                    <div class="col-lg-8 ml-auto">
                                                        ...
                                                        <a href="./admin/outlet.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
                                            </form>
                <!--end::Modals-->
		<!--begin::Scrolltop-->
