										...
										<div class="mb-10">
                                                 ...
                                                 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.min.js" integrity="sha384-j0CNLUeiqtyaRmlzUHCPZ+Gy5fQu0dQ6eZ/xAww941Ai1SxSY+0EQqNXNE6DZiVc" crossorigin="anonymous"></script>
                                                            ...
                                                            $no++;?>
                                                                    <tr class="text-xs font-weight-bold">
                                                                        ...
                                                                        <td class="align-middle text-left"><?=$data_member['id_member']?></td>
                                                                        <td class="align-middle text-left"><?=$data_member['nama_member']?></td>
                                                                        <td class="align-middle text-left"><?=$data_member['alamat']?></td>
                                                                        <td class="align-middle text-left"><?=$data_member['jenis_kelamin']?></td>
                                                                        <td class="align-middle text-left"><?=$data_member['tlp']?></td> 
                                                                        <td class="align-middle text-left">
                                                                        <a class="btn btn-success" href="./admin/ubah_member.php?id_member=<?=$data_member['id_member']?>" ><i class="far fa-edit"></i></a>
                                                                        <a href="./admin/hapus_member.php?id_member=<?=$data_member['id_member']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                    }
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title" id="exampleModalLabel">Tambah Member Laundry</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <form method="POST" action="admin/proses_tambah_member.php" enctype="multipart/form-data">
                                                    <section class="base">
                                                    <div class="mb-3">
