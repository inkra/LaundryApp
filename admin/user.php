							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								...
								<ul class="breadcrumb fw-bold fs-base my-1">
									<li class="breadcrumb-item text-muted">
										<a href="index_admin.php" class="text-muted">Home</a>
									</li>
										...
										<div class="mb-10">
                                                 ...
                                                 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.min.js" integrity="sha384-j0CNLUeiqtyaRmlzUHCPZ+Gy5fQu0dQ6eZ/xAww941Ai1SxSY+0EQqNXNE6DZiVc" crossorigin="anonymous"></script>
                                                            ...
                                                            $no++;?>
                                                                    <tr class="text-xs font-weight-bold">
                                                                        ...
                                                                        <td class="align-middle text-left"><?=$data_user['id_user']?></td>
                                                                        <td class="align-middle text-left"><?=$data_user['nama_user']?></td>
                                                                        <td class="align-middle text-left"><?=$data_user['username']?></td>
                                                                        <td class="align-middle text-left"><?=$data_user['password']?></td>
                                                                        <td class="align-middle text-left"><?=$data_user['nama']?></td> 
                                                                        <td class="align-middle text-left"><?=$data_user['role']?></td>
                                                                        <td class="align-middle text-left">
                                                                        <a class="btn btn-success" href="./admin/ubah_user.php?id_user=<?=$data_user['id_user']?>" ><i class="far fa-edit"></i></a>
                                                                        <a href="./admin/hapus_user.php?id_user=<?=$data_user['id_user']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                    }
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h5 class="modal-title" id="exampleModalLabel">Tambah User Laundry</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                    <form method="POST" action="admin/proses_tambah_user.php" enctype="multipart/form-data">
                                                    <section class="base">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label">Role User</label>
