							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link active" href="./admin/paket.php" data-kt-page="pro">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-1 fs-2">Our Paket Laundry</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">CRUD Paket</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
										...
										<div class="mb-10">
                                                 ...
                                                 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.min.js" integrity="sha384-j0CNLUeiqtyaRmlzUHCPZ+Gy5fQu0dQ6eZ/xAww941Ai1SxSY+0EQqNXNE6DZiVc" crossorigin="anonymous"></script>
                                                            ...
                                                            <table class="table table-hover my-0">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>Id Paket</th>
                                                                        <th>Nama Outlet</th>
                                                                        <th class="d-none d-xl-table-cell">Jenis Paket</th>
                                                                        <th class="d-none d-xl-table-cell">Nama Paket</th>
                                                            ...
                                                            $no++;?>
                                                                    <tr class="text-xs font-weight-bold">
                                                                        ...
                                                                        <td class="align-middle text-left"><?=$data_paket['id_paket']?></td>
                                                                        <td class="align-middle text-left"><?=$data_paket['nama']?></td>
                                                                        <td class="align-middle text-left"><?=$data_paket['jenis']?></td>
                                                                        <td class="align-middle text-left"><?=$data_paket['nama_paket']?></td> 
                                                                        <td class="align-middle text-left">Rp.<?=$data_paket['harga']?></td>
                                                                        <td class="align-middle text-left">
                                                                        <a class="btn btn-success" href="./admin/ubah_paket.php?id_paket=<?=$data_paket['id_paket']?>" ><i class="far fa-edit"></i></a>
                                                                        <a href="./admin/hapus_paket.php?id_paket=<?=$data_paket['id_paket']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                    }
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="admin/proses_tambah_paket.php" enctype="multipart/form-data">
                                                    <section class="base">
                                                    <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label">Id Paket</label>
