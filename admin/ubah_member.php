					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-nav d-flex flex-column flex-lg-center flex-column-fluid w-100 pt-5 pt-lg-0" id="kt_aside_nav">
							...
							<div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" data-kt-menu-flip="bottom" class="menu-item py-2">
									<span class="menu-link active menu-center" title="Customers" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon me-0">
									...
									<div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
										...
										<div class="menu-item">
											<a class="menu-link active" href="admin/member.php" title="Silahkan melakukan registrasi pelanggan baru" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
						...
						<div class="aside-workspace overflow-auto my-2 my-lg-7 px-3 px-lg-7" id="kt_aside_wordspace">
							...
							<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
								<div id="kt_aside_menu_wrapper" class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-offset="20px" data-kt-scroll-wrappers="#kt_aside_wordspace">
									<div class="menu-item">
										<div class="menu-content">
											<span class="menu-section fs-5 fw-bolder ps-1 py-1">CRUD Pelanggan</span>
										</div>
									</div>
									<div class="menu-item">
										<a class="menu-link active" href="./admin/member.php">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-1 fs-2">Our Member</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">CRUD Pelanggan</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
										...
										<div class="mb-10">
											<!--begin::Top-->
                                                ...
                                                <div class="mb-3" style="text-align: left;">
                                                    <strong><label class="col-lg-4 col-form-label" for="val-username">Id Member<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-username" name="id_member" placeholder="Enter id kelas.." value="<?= $data['id_member']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-email">Nama Member<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" id="val-email" name="nama_member" placeholder="Enter nama kelas.." value="<?= $data['nama_member']?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3" style="text-align: left;">
                                                <strong><label class="col-lg-4 col-form-label" for="val-password">Alamat Member<span class="text-danger">*</span>
                                                    </label></strong>
                                                    <div class="col-lg-12">
